...
@Component({
  ...
  styleUrls: ['./sector1.component.css'],
})
export class Sector1Component implements OnInit {
  ...
  ngOnInit(): void {
    this.messageService.sendMessage('sector1');
  ...
  getNews1() {
    this.newsservice.getNews1(2).subscribe(result => {
