...
@Component({
  ...
  styleUrls: ['./sector4.component.css']
})
export class Sector4Component implements OnInit {
  newsData1: any = [];
  newsData: any;
  displayData: any = [];
  loanData: any;
  ...
  ngOnInit(): void {
    ...
    this.getNews1();
    this.getNews();
    this.messageService.sendMessage('sector4');
  }
  ...
  getNews1() {
    this.newsservice.getNews1(5).subscribe(result => {
      //  for(var i=0 ; i< this.newsdata)
