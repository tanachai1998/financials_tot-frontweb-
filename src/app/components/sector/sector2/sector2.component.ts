...
@Component({
  ...
  styleUrls: ['./sector2.component.css'],
})
export class Sector2Component implements OnInit {
  ...
  ngOnInit(): void {
    this.messageService.sendMessage('sector2');
  ...
  getNews1() {
    this.newsservice.getNews1(3).subscribe(result => {
