...
@Component({
  ...
  styleUrls: ['./sector3.component.css'],
})
export class Sector3Component implements OnInit {
  ...
  ngOnInit(): void {
    this.messageService.sendMessage('sector3');
  ...
  getNews1() {
    this.newsservice.getNews1(4).subscribe(result => {
